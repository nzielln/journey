...
public class TasksRecyclerViewAdapter extends FirebaseRecyclerAdapter<TaskItemModel, ProfileTodoViewHolder> {
    ...
    public TasksRecyclerViewAdapter(@NonNull FirebaseRecyclerOptions<TaskItemModel> options) {
        super(options);
    }
